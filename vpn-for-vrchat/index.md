...
Фактически, у VRChat очень мало своей инфраструктуры, он опирается **на множество стороних сервисов: Amazon AWS, Cloudflare, Photon Unity Networking и т.п.**
...
## И что же делать?
**Краткий ответ:** либо добротный **VPN**, либо средства против DPI, например, **zapret**.
...
Так вот, он позволяет настроить **WARP** буквально **в два клика**.
