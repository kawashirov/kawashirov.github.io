...
# Но у меня ещё и не работают плееры: видео и музыка
...
По этому, **они борятся** с такими программами как `yt-dlp` и признают её использование **ботоводством**,
а в сам сайт и приложения встраивают специальные средства **обфускации и защиты**.
