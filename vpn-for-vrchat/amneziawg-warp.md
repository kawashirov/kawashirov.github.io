...
Вариантов не много:
1. Сгенерировать новый конфиг с другими опциями.
...
2. Поменять Peer Endpoint на другой.
...
3. [Использовать более **новую версию AmneziaWG**: 1.5 или лучше **2**.](./amneziawg-v2.md)
4. Поменять настройки обфускации Amnezia.
