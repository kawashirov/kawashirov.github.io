...
На "Домашнем" XRay создаётся Inbound типа tunnel (он же dokodemo door) от какого-то порта (например, Port 5070) к какому-нибудь из IP и порту Cloudflare WARP (например, Network UDP, Target Address 162.159.192.1, Destination Port 500), а в кчачестве Dialer Proxy указывается ваш Outbound на XRay на VPS.
